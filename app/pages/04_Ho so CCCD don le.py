...
from core import text_field, date_field, selectbox_field, get_info, chuyen_khong_dau, up_field, get_rois
...
if submitted is not None and so_dien_thoai_dang_ky != ' ':
    ...
    so_giay_to, _, ho_ten, ngay_sinh, nam_nu, dia_chi_thuong_tru, ngay_cap = tt_cccd[-1].split('|')        
